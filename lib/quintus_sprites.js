...
//            if(this.asset == 'scaffold/Shank.png'){
//                //debugger;
...
//            }
            ...
            ctx.drawImage(Q.asset(this.asset),
                this.fx(frame), this.fy(frame),
                this.swidth || this.tileW, this.sheight || this.tileH,  //add support swidth and sheight http://www.w3school.com.cn/html5/canvas_drawimage.asp
                Math.floor(x), Math.floor(y),
                this.tileW, this.tileH);
        }
